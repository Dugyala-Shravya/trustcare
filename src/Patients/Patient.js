...
function Patient() {
  ...
  useEffect(() => {
    axios.get('https://hospital-7w52.onrender.com/patients')
  .then((response) => {
  ...
  const handleDeletePatient = (PatientId) => {
    ...
    axios.delete(`https://hospital-7w52.onrender.com/Patients/${PatientId}`)
      .then(() => {
  ...
  const handleEditPatient = (editedPatient) => {
    ...
    axios.put(`https://hospital-7w52.onrender.com/Patients/${editedPatient.id}`, editedPatient)
      .then(() => {
